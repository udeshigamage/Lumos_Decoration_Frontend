      ...
      {ismodelopen && (
        <dialog open className="modal modal-bottom sm:modal-middle">
          <div className="modal-box">
            ...
            <div className="flex position-relative  gap-5 py-5">
            ...
            <div className="flex position-relative gap-12 py-5">
            ...
            <div className="flex position-relative  gap-11 py-5">
            ...
            <div className="flex position-relative  gap-10 py-5">
            ...
            <div className="flex position-relative  gap-6 py-5">
            ...
            <div className="modal-action ">
              <div className="flex positon-relative gap-5">
                <button className="btn">Estimate payment</button>
