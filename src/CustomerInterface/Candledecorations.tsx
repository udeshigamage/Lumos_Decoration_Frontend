        ...
        {garlands.map((item, index) => (
          ...
          >
            ...
            <div className="flex flex-col p-1 m-1">
              <h2 className=" text-lg font-serif font-semibold p-1 rounded-lg bg-amber-100 ">
                {item.name}
              </h2>
              ...
              <div className="flex flex-row justify-end">
                <button className="btn btn-sm w-15 bg-black text-white hover:bg-gray-600 font-serif">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
